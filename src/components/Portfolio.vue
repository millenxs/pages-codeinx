...
const projects = [
  {
    ...
    category: 'Aplicativo Web • React • Finanças',
  ...
  },
  {
    ...
    category: 'E-commerce • Shopify • Recomendações com IA',
  ...
  <section class="py-24 bg-surface-light dark:bg-surface-dark" id="portfolio">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-16">
        ...
        <p class="text-slate-600 dark:text-slate-400">Veja como ajudamos empresas a crescer com design web inteligente.</p>
      </div>
      ...
      <div class="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div class="flex justify-between items-start">
            <div>
              <h3 class="text-xl font-bold text-navy dark:text-white group-hover:text-primary transition-colors">{{ project.title }}</h3>
              <p class="text-sm text-slate-500 dark:text-slate-400">{{ project.category }}</p>
            </div>
