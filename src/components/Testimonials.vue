  ...
  <section class="py-24 bg-background-light dark:bg-background-dark border-t border-slate-200 dark:border-slate-800" id="testimonials">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid md:grid-cols-2 gap-12 items-center">
        <!-- Left - Testimonial -->
        <div>
          <h2 class="text-3xl md:text-4xl font-display font-bold text-navy dark:text-white mb-6">Histórias de Sucesso de Clientes</h2>
          <p class="text-slate-600 dark:text-slate-400 mb-8 text-lg">
            "A Codeinx transformou nossa presença digital. Sua abordagem orientada por IA em nossas landing pages aumentou nossa taxa de conversão em 140% em apenas dois meses."
          </p>
          <div class="flex items-center gap-4">
            ...
            />
            <div>
              <p class="font-bold text-navy dark:text-white">Marcus Chen</p>
              <p class="text-sm text-slate-500">CMO, VentureFlow</p>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 col-span-2">
            ...
            <p class="text-sm text-slate-600 dark:text-slate-400">Monitoramento de Sistema com IA</p>
          </div>
        </div>
      </div>
    </div>
