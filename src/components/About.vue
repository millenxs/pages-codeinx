...
import { Rocket, Star, Zap, TrendingUp, BrainCircuit } from 'lucide-vue-next'
  ...
  <section class="py-24 bg-white">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="grid gap-12 lg:grid-cols-2 items-center">
        <div>
          <div class="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-teal-50 to-lime-50 px-4 py-2 border border-teal-200 mb-6">
            <BrainCircuit class="h-4 w-4 text-teal-600" />
            <span class="text-sm text-slate-700">Liderando a Revolução da IA</span>
          </div>
          
          <h2 class="text-3xl sm:text-4xl lg:text-5xl text-slate-900 mb-6">
          ...
          <div class="space-y-4 text-lg text-slate-600">
            <p>
              ...
              virtuais <strong class="text-slate-900">potencializados por Inteligência Artificial</strong> que 
              transformam sua presença online e impulsionam suas vendas.
            </p>
            
            <p>
              Combinamos design inovador, <strong class="text-slate-900">tecnologia de IA de ponta</strong>, 
        ...
        <div class="grid gap-6 sm:grid-cols-2">
          <div
            ...
            :key="highlight.title"
            class="group relative p-6 rounded-2xl bg-gradient-to-br from-stone-50 to-stone-100 border border-slate-200 transition-all hover:shadow-lg hover:scale-105 hover:border-teal-400 overflow-hidden"
          >
            <!-- Animated gradient on hover -->
            <div class="absolute inset-0 bg-gradient-to-br from-teal-500/0 to-lime-500/0 group-hover:from-teal-500/5 group-hover:to-lime-500/5 transition-all"></div>
            
            <div class="relative">
              <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-slate-900 to-slate-700 text-lime-400 mb-4 group-hover:scale-110 transition-transform shadow-lg shadow-slate-900/20">
                <component :is="highlight.icon" class="h-6 w-6" />
              </div>
              
              <h3 class="text-xl text-slate-900 mb-2">
                {{ highlight.title }}
              </h3>
